...
<div class="mb-3"><label for="password">Mot de passe<?= $action==='signup'?' (12 caractères minimum)':'' ?></label><div class="password-field"><input class="form-control" type="password" id="password" name="password" <?= $action==='signup'?'aria-describedby="password-rules"':'' ?> autocomplete="<?= $action==='signup'?'new-password':'current-password' ?>" required><button class="password-toggle" type="button" data-password-toggle="password" aria-controls="password" aria-pressed="false">Afficher</button></div></div>
<?php if ($action==='signup'): ?>
...
<div class="mb-3"><label for="confirm">Confirmer le mot de passe</label><div class="password-field"><input class="form-control" type="password" id="confirm" name="password_confirm" autocomplete="new-password" aria-describedby="confirm-help" required><button class="password-toggle" type="button" data-password-toggle="confirm" aria-controls="confirm" aria-pressed="false">Afficher</button></div><p id="confirm-help" class="field-help" aria-live="polite"></p></div>
